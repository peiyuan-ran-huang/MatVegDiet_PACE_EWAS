...
## --------------------------------------------------------------------------- ##
## 3.  Load ALSPAC reference methylation matrix                                ##
## --------------------------------------------------------------------------- ##

cat("Reading phenotype file …\n")
pheno <- readRDS("/user/work/zd20208/MatVegDiet_PACE_EWAS/results/ALSPAC/MatVegDiet.ALSPAC.pheno.SV.birth.20250709.rds")
