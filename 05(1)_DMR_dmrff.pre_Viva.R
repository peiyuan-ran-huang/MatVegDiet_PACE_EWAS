...
pheno.file     <- "/user/work/zd20208/MatVegDiet_PACE_EWAS/results/Viva/MatVegDiet.Viva.pheno.SV.birth.20250709.rds"
meth.file      <- "/user/work/zd20208/MatVegDiet_PACE_EWAS/data/Viva/betas_cord.Rdata"
ewas.dir       <- "/user/work/zd20208/MatVegDiet_PACE_EWAS/results/Viva/"
ewas.prefix    <- "ewas.res"
platform       <- "450k"

out.dir        <- file.path("/user/work/zd20208/MatVegDiet_PACE_EWAS/results/Viva/DMR")
...
load(meth.file)
meth <- as.matrix(betas_cord[, pheno$sample.id])
rm(betas_cord)
